...
- **Le Wake-on-LAN a une condition matérielle** : la carte réseau doit rester **reliée et alimentée** quand l'appareil est éteint, pour pouvoir le réveiller. C'est généralement le cas de l'Ethernet intégré des TV, rarement du Wi-Fi, et **jamais d'un adaptateur USB-Ethernet** (Mi Box + adaptateur par exemple) : à l'extinction, le boîtier coupe les **données** du bus USB. L'adaptateur peut rester alimenté et visible sur le réseau (son adresse MAC répond toujours), mais son lien avec le boîtier est mort : le magic packet arrive à l'adaptateur et s'arrête là, il ne peut pas réveiller le boîtier. Dans ce cas, mettez le boîtier en **veille** plutôt qu'en arrêt complet — sur la plupart des boîtiers, c'est ce que fait le bouton marche/arrêt de la télécommande — : la box reste joignable et le protocole Remote v2 suffit à la rallumer depuis Gladys, sans Wake-on-LAN ni adresse MAC.
...
- **Bug d'affichage connu du filtre (Gladys v5)** : au premier passage, filtrer le menu déroulant peut retourner une **liste vide** alors que l'appareil existe. Tapez le nom recherché puis **cliquez à nouveau sur le champ** : la liste filtrée apparaît correctement cette fois. (Merci lmilcent pour le contournement.)
